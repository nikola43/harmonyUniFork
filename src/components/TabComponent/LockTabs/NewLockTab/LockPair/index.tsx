...
import { useLockerState, setLockerStep } from 'state/locker/locker.store'
    ...
    return (
        lockerStep === "pair_selected" ?
            <div>
                ...
                <ColumnCenter>
                    <TYPE.text_lg color={'primary4'} margin={2}>Lock Liquidity</TYPE.text_lg>
                    ...
                    <TYPE.text_xxs color={'text4'} textAlign={'center'}>Your balance: 0.02 ETH</TYPE.text_xxs>
