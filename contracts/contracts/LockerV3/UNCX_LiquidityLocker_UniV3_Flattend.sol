...
// SPDX-License-Identifier: GPL-2.0-or-later AND GPL-3.0 AND MIT AND UNLICENSED
...
// File contracts/LockerV3/INonfungiblePositionManager.sol
...
// File contracts/LockerV3/IMigrateV3NFT.sol
...
// File contracts/LockerV3/IUNCX_LiquidityLocker_UniV3.sol
...
// File contracts/LockerV3/FullMath.sol
...
// File contracts/LockerV3/LiquidityAmounts.sol
...
// File contracts/LockerV3/ICountryList.sol
...
// File contracts/LockerV3/TickMath.sol
...
// File contracts/LockerV3/UNCX_LiquidityLocker_UniV3.sol
...
interface IFeeResolver {
    function useFee(
        bytes[] memory r,
        address sender
    ) external returns (IUNCX_LiquidityLocker_UniV3.FeeStruct memory fee);
}

contract UNCX_LiquidityLocker_UniV3 is
    IUNCX_LiquidityLocker_UniV3,
    Ownable2Step,
    IERC721Receiver,
    ReentrancyGuard
{
    ...
    function allowNftPositionManager(
    ...
    */
    function lock(
        ...
        require(
            allowedNftPositionManagers.contains(
                address(params.nftPositionManager)
            ),
